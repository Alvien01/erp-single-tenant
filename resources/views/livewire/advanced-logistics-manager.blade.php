<div class="space-y-6">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h1 class="text-3xl font-bold font-display text-gray-900 tracking-tight">Advanced Logistics</h1>
            <p class="text-sm text-gray-500 mt-1">Manage delivery carriers, dropshipping, and cross-docking.</p>
        </div>
    </div>
    ...
    <div class="border-b border-gray-200">
        <nav class="-mb-px flex space-x-8" aria-label="Tabs">
            <button wire:click="$set('activeTab', 'carriers')" class="{{ $activeTab === 'carriers' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                Delivery Carriers (API)
            </button>
            <button wire:click="$set('activeTab', 'dropship')" class="{{ $activeTab === 'dropship' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                Dropship Orders
            </button>
        </nav>
    </div>
