<div class="space-y-6">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h1 class="text-3xl font-bold font-display text-gray-900 tracking-tight">Website & CMS Ecosystem</h1>
            <p class="text-sm text-gray-500 mt-1">Manage pages, blogs, appointments, events, and eLearning.</p>
        </div>
    </div>
    ...
    <div class="border-b border-gray-200">
        <nav class="-mb-px flex space-x-6 overflow-x-auto" aria-label="Tabs">
            @foreach(['pages', 'blog', 'appointments', 'events', 'elearning'] as $tab)
